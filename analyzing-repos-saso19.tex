...
phase change, and a phase change happens by passing a critical state. 
...
But to really start to understand the behavior of software development teams as
reflected by their activity in repositories, we should not
only try to fit a power law in our data but making a statistically
...
changes, establishing a statistically correct starting point to answer the question: Does software
