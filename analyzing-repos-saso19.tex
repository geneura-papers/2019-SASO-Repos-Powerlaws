...
we have crossed a momentary critical state described by a power law. % I don't like how this sentence is built... Too roundabout - JJ.  Changed
...
distribution. The main reason for this change is the variation of the $x_{min}$ parameter, due to the existence of a different range of commits that fits a powerlaw better than the previous one. % Implying what? - JJ Strong variations in the parameters are not been producing by a change in the distribution, but due to a change in the starting parameter. Adressed in 473
%
\begin{table*}[h!tbp]
