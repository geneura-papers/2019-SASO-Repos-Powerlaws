...
distribution. The book analyzed by \cite{merelo16:slash} had a median
...
software library analyzed by \cite{Merelo2016:repomining} had a median
...
found by \cite{merelo16:slash}, where it hovers around 6 for the intercept and
